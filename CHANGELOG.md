...
### Added
- **Ecological Modeling Hub**: Added `046_ecological_modeling.sql` with 4 governed tables (ecological_interaction, ecological_model_run, energy_flow_measurement, population_dynamics_record), 6 public views, 4 metric definitions (ecological_interaction_count, trophic_balance_index, energy_flow_efficiency_pct, population_stability_index), 2 dashboards (62-63), 5 Adelphi pilot interactions, 3 energy flow measurements, 4 population dynamics records, 1 model run, `services.analytics.ecological_modeling`, `services.agents.ecological_modeling_agent`, 2 report types (44 total), trophic classification extensions to species_observation and farm_zone, docs, and tests.
