...
('crisp', 'Carbon Risk Scoring', 'Internal farm risk intelligence engine with five-factor scoring (carbon yield, climate, policy, financial, implementation), configurable per-location weights, and composite AAA-D rating. Adapted from Solid World SW-CRISP framework.', NULL, 'risk_framework', 'active', '{"role":"risk review","version":"2.0","adapted_from":"SW-CRISP"}'::jsonb),
