...
INSERT INTO cultural_context_record (
    id, location_id, farm_id, practice_name, practice_type, stakeholder_group,
    language, description, public_summary, consent_given, consent_scope, is_public,
...
(
    ...
    'a0000000-0000-0000-0000-000000000001',
    'a0000000-0000-0000-0000-000000000010',
    'Spanish operator summaries',
    'local_language',
    'farm_operator',
    'es',
    'Operators requested simple Spanish-language monthly summaries so evidence and operational learning are useful at the farm level.',
    'Adelphi tracks Spanish-language operator summaries as a cultural accessibility and practical learning signal.',
    TRUE,
    'public_summary',
    TRUE,
    3,
    'published',
    '{"source_feedback_id":"a0000000-0000-0000-0000-000000000900","capital":"cultural"}'::jsonb,
    'pilot_seed',
    'adelphi-cultural-language-2026-03',
    '{"record_type":"cultural_context_record","privacy":"public_summary_private_raw"}'::jsonb
),
(
    'a0000000-0000-0000-0000-000000000941',
    'a0000000-0000-0000-0000-000000000001',
    'a0000000-0000-0000-0000-000000000010',
    'Syntropic and bioinput field learning',
    'traditional_knowledge',
    'farm_operator',
    'es',
    'Adelphi combines syntropic beds, biofactory practice, and local agronomic learning into operator-facing field routines.',
    'Adelphi records syntropic and bioinput field learning as practical knowledge transfer, not as a public claim over private cultural knowledge.',
    TRUE,
    'public_summary',
    TRUE,
    3,
    'published',
    '{"capital":"cultural","knowledge_boundary":"public practice summary only"}'::jsonb,
    'pilot_seed',
    'adelphi-cultural-field-learning-2026-03',
    '{"record_type":"cultural_context_record","privacy":"public_summary_private_raw"}'::jsonb
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO wellbeing_metric_observation (
    id, location_id, farm_id, metric_key, observation_date, stakeholder_group,
    language, score_value, count_value, text_value, public_summary, source_tables,
    source_record_ids, evidence_maturity, status, metadata, source_system, source_id, source_raw
) VALUES
(
    ...
    NULL,
    NULL,
    'Operators report improved capability around syntropic beds and bioinput operations, with a need for simpler Spanish reporting.',
    ARRAY['stakeholder_feedback', 'stakeholder_outcome'],
    ARRAY['a0000000-0000-0000-0000-000000000900', 'a0000000-0000-0000-0000-000000000910']::uuid[],
    3,
    'published',
    '{"interpretation":"reviewed social signal, not external certification"}'::jsonb,
    'pilot_seed',
    'adelphi-wellbeing-operator-capability-2026-03',
    '{"record_type":"wellbeing_metric_observation"}'::jsonb
),
(
    ...
    1,
    NULL,
    'One Spanish-language operator summary requirement was identified and accepted for monthly tracking.',
    ARRAY['stakeholder_feedback', 'metric_proposal'],
    ARRAY['a0000000-0000-0000-0000-000000000900', 'a0000000-0000-0000-0000-000000000930']::uuid[],
    3,
    'published',
    '{"expected_monthly_summary_count":2,"delivered_or_committed_count":1}'::jsonb,
    'pilot_seed',
    'adelphi-wellbeing-language-coverage-2026-03',
    '{"record_type":"wellbeing_metric_observation"}'::jsonb
),
(
    ...
    NULL,
    NULL,
    'Community trust is supported by visible farm activity and explicit protection of household-level feedback privacy.',
    ARRAY['stakeholder_feedback', 'stakeholder_feedback_review'],
    ARRAY['a0000000-0000-0000-0000-000000000901', 'a0000000-0000-0000-0000-000000000903']::uuid[],
    3,
    'published',
    '{"privacy_boundary":"household-level observations stay private"}'::jsonb,
    'pilot_seed',
    'adelphi-wellbeing-community-trust-2026-03',
    '{"record_type":"wellbeing_metric_observation"}'::jsonb
),
(
    ...
    2,
    NULL,
    'Two public-safe cultural context records are published for Adelphi: Spanish operator summaries and syntropic/bioinput field learning.',
    ARRAY['cultural_context_record'],
    ARRAY['a0000000-0000-0000-0000-000000000940', 'a0000000-0000-0000-0000-000000000941']::uuid[],
    3,
    'published',
    '{"public_safe_count":2}'::jsonb,
    'pilot_seed',
    'adelphi-wellbeing-cultural-count-2026-03',
    '{"record_type":"wellbeing_metric_observation"}'::jsonb
)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO participatory_action_record (
    id, location_id, farm_id, stakeholder_feedback_id, metric_proposal_id,
    action_type, action_date, stakeholder_group, action_summary, public_summary,
    decision_status, evidence_maturity, status, metadata
) VALUES (
    ...
    '2026-03-08',
    'farm_operator',
    'Operator feedback requesting simpler Spanish summaries was converted into a participatory metric proposal for monthly tracking.',
    'Adelphi operator feedback led to an approved participatory metric for Spanish monthly operator summaries.',
    'completed',
    3,
    'published',
    '{"trace":"stakeholder_feedback_to_metric_proposal","public_safe":true}'::jsonb
)
ON CONFLICT (id) DO UPDATE SET
    stakeholder_feedback_id = EXCLUDED.stakeholder_feedback_id,
    metric_proposal_id = EXCLUDED.metric_proposal_id,
